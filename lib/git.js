...
GitSash;var _shellHelper = require('shell-helper');var _shellHelper2 = _interopRequireDefault(_shellHelper);var _common = require('./common');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // BRANCH_NAME=`git branch | grep "^* " | cut -d" " -f 2`
...
require('colors');var ConfigKey = exports.ConfigKey = { askBeforeRunCommand: 'askBeforeRunCommand', syncBranch: 'syncBranch', syncRemote: 'syncRemote' };function wrapBranchNameSafe(branchName) {var alreadyWrap = branchName[0] === '"' && branchName[branchName.length - 1] === '"';return alreadyWrap ? branchName : '"' + branchName + '"';}function replaceBranchNameForWeb(branchName) {return encodeURIComponent(branchName);}function GitSash(config) {var iterateRemote = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(fn) {var remoteNames, i;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              ...
              i = 0;case 5:if (!(i < remoteNames.length)) {_context.next = 11;break;}_context.next = 8;return (
                Promise.resolve(fn(remoteNames[i])));case 8:i++;_context.next = 5;break;case 11:case 'end':return _context.stop();}}}, _callee, this);}));return function iterateRemote(_x) {return _ref.apply(this, arguments);};}();var iterateLocalBranches = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee2(fn) {var branches, i;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              ...
              i = 0;case 2:if (!(i < branches.length)) {_context2.next = 8;break;}_context2.next = 5;return (
                Promise.resolve(fn(branches[i])));case 5:i++;_context2.next = 2;break;case 8:case 'end':return _context2.stop();}}}, _callee2, this);}));return function iterateLocalBranches(_x2) {return _ref2.apply(this, arguments);};}();var getRemoteNameToSync = function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee10(fn) {var hasStash;return _regenerator2.default.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:
              ...
              console.log('You have local changes. Let\'s stash first.');_context10.next = 5;return (
                ...
                Promise.resolve(fn()));case 8:_context10.next = 14;break;case 10:_context10.prev = 10;_context10.t0 = _context10['catch'](5);
